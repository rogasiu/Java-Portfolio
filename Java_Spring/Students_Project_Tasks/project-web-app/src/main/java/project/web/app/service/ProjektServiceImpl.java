...
public class ProjektServiceImpl implements ProjektService {
	...
	public Projekt setProjekt(Projekt projekt) {
		if(projekt.getProjektId()!= null) { //modyfikacja istniejącego projektu
			...
			//jeżeli usługa miałaby zwracać utworzony obiekt, a nie link to trzeba użyć
	...
	private Page<Projekt> getPage(URI uri, RestTemplate restTemplate) {
		return ServiceUtil.getPage(uri, restTemplate, new ParameterizedTypeReference<RestResponsePage<Projekt>>() {});
	}
