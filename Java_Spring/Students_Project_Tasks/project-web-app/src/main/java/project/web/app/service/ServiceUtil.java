...
public class ServiceUtil {
	public static <T> RestResponsePage<T> getPage(URI uri, RestTemplate restTemplate, 
		...
		ResponseEntity<RestResponsePage<T>> result = restTemplate.exchange(uri, 
	...
	public static UriComponentsBuilder getUriComponent(String serverUrl, String resourcePath, Pageable pageable) {
		return getUriComponent(serverUrl, resourcePath)
			.queryParam("page", pageable.getPageNumber())
			.queryParam("size", pageable.getPageSize())
